...
<?php
    if(isset($_POST["submit"])){
        ...
        if(isset($ten) && isset($email) && isset($sdt) && isset($diachi)){
            ...
            // Phải chỉnh sửa lại
            $mailer->Username = "wigg.shop@gmail.com"; // GMAIL username
            $mailer->Password = "myshop.1"; // GMAIL password
            $mailer->AddAddress($email, $ten); //email người nhận, $email và $ten là 2 biến đc gán bởi $_POST lấy từ trong form
            $mailer->AddCC("wigg.shop@gmail.com", "Admin Wigg Shop"); // gửi thêm một email cho Admin

            // Chuẩn bị gửi thư nào
            $mailer->FromName = 'Wigg Shop'; // tên người gửi
            $mailer->From = 'wigg.shop@gmail.com'; // mail người gửi
            $mailer->Subject = 'Hóa đơn xác nhận mua hàng từ Wigg Shop';
